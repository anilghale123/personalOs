  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Dialogs are centred with translate(-50%, -50%); the keyframes
        // must carry that translate or the animation overrides it and the
        // dialog visibly jumps in from the wrong spot.
        "dialog-in": {
